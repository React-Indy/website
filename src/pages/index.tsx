...
const HomePage = () => {
	return (
		<main className="flow">
			...
			<p>
				The quick version: <strong>React.Indy</strong> is dedicated to providing
				...
				technology choices. We do not tolerate harassment of event participants
				or group members in any form.
			</p>
		</main>
	);
};
